...
This command automatically downloads and registers the skill in your local Agents environment. But you still need to run the manual initialization steps below before syncing.
